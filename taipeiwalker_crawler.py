...
##旅遊版 http://www.taipeiwalker.com.tw/p4.php?seriesa=1&page=
##食物版 http://www.taipeiwalker.com.tw/p4.php?seriesa=2&page=
##生活版 http://www.taipeiwalker.com.tw/p4.php?seriesa=3&page=
##藝術版 http://www.taipeiwalker.com.tw/p4.php?seriesa=4&page=
##影音版 http://www.taipeiwalker.com.tw/p4.php?seriesa=5&page=
##數位版 http://www.taipeiwalker.com.tw/p4.php?seriesa=6&page=
...
class tpw:
	...
	##抓取內文網址
    ##board 要爬取的版別
    ##endDate 設定日期，從今日開始直到設定日期為止所有文章
	...
	##開啟抓取下來的檔案，及寫入json
	##board 要開啟的檔案位於哪個版別資料夾下
	##sinceDate 取得page_content下指定日期以前所有的txt檔
	##move 將轉完json的txt檔移到saved資料夾下
	...
	##將檔案內容寫成dict並回傳給getParsedContent以方便製作成json格式
	##fileName 要開啟的txt檔名
    ##board 該檔位於哪個版別資料夾
